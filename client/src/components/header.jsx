  ...
  const deleteCompanyModalContent = (
    <div className="modal-container">
      <div className="modal-content">
        ...
        <p>
          All content associated with this organization will be erased upon
          confirmation
        </p>
        <div className="button-container">
          <Button
    ...
    <>
        ...
        <Toolbar>
          ...
          >
            ...
            {userRole.some((role) => role === "Admin" || role === "Owner") && [
              <MenuItem key="addUzer" onClick={handleAddUserClick}>
                Add User
              </MenuItem>,
            ]}
      ...
      {showDeleteCompanyModal && (
        <Modal
          ...
          closeAfterTransition
        >
          <Fade in={showDeleteCompanyModal}>{deleteCompanyModalContent}</Fade>
        </Modal>
      )}
    </>
  );
